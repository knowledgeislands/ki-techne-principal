...
Trivial corrections, time-bound [[Calendar]] entries, and inbound `+/` triage do not require a full proposal. When a change affects canonical meaning, structure, policy, or classification, use a proposal.
